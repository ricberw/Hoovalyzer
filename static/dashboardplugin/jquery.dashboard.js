...
(function($) { // Create closure.
  ...
  $.fn.dashboard = function(options) {
    ...
    $('#' + dashboard.id + ' .widgetClose').live('click', function() {
      dashboard.log('widgetClose event thrown for widget ' + widget.id,2);
      var wi = dashboard.getWidget($(this).closest('.' + opts.widgetClass).attr("id"));
    ...
    $('#' + dashboard.id + ' .widgetDeleted').live('click', function() {
      dashboard.log('widgetDeleted event thrown for widget ' + widget.id,2);
      var wi = dashboard.getWidget($(this).closest('.' + opts.widgetClass).attr("id"));
  ...
  $.fn.dashboard.defaults = {
    debuglevel:0,
    json_data: {},
    loadingHtml: '<div class="loading"><img alt="Loading, please wait" src="static/dashboardplugin/themes/default/loading.gif" /><p>Loading...</p></div>',
